...
def dependency_exc(exc: Exception, extra: str) -> NoReturn:
    ...
    raise ImportError(
        f"Missing dependency. To install all dependencies run:\n\n\tpip install {package}\n"
    ) from exc


def validate_clip() -> None:
    try:
        import clip  # pylint: disable=import-outside-toplevel,unused-import # noqa: F401
...
def validate_resnet() -> None:
    try:
        import torch  # pylint: disable=import-outside-toplevel,unused-import # noqa: F401
