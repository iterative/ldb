...
def process_query_args(
    ...
    if len(limit_query_args) > 1:
        raise ValueError("--limit may only be used once")
    ...
    limit_query = int(limit_query_args[0]) if limit_query_args else 0
    return annot_query, file_query, limit_query
