...
def test_ls_data_objects(ldb_instance, workspace_path, index_original):
    ...
    expected = [
        DatasetListing(
            ...
            data_object_path=osp.join(
                ORIGINAL_DIR,
                "data_objects_only/00014.png",
            ),
            annotation_hash="",
            annotation_version=0,
        ),
        ...
        DatasetListing(
            ...
            data_object_path=osp.join(ORIGINAL_DIR, "has_both/test/00025.png"),
            annotation_hash="818e4e07715f01efd2b8b823163b910d",
            annotation_version=1,
        ),
        DatasetListing(
            data_object_hash="ebbc6c0cebb66738942ee56513f9ee2f",
            data_object_path=osp.join(ORIGINAL_DIR, "has_both/test/00047.png"),
